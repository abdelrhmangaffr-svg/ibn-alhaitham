...
<head>
<meta charset="UTF-8">
<title>نظام ابن الهيثم - جامعة المنوفية</title>
...
<div class="container" id="loginPage">
    <h1>نظام ابن الهيثم</h1>
    <h2>جامعة المنوفية</h2>

    <input type="text" id="code" placeholder="كود الطالب">
    <input type="password" id="nid" placeholder="الرقم القومي">
...
<div class="container hidden" id="studentPage">
    ...
    <p><strong>الكلية:</strong> الهندسة</p>
    <p><strong>الفرقة:</strong> الأولى</p>
...
function login() {
    ...
    // بيانات تجريبية
    if (code === "12345" && nid === "29901010101010") {
